...
namespace TowerDefence.Bullets
{
    ...
    {
        public IceBullet(IServiceProvider serviceProvider, float damage, Vector2 position, Creep destinationCreep)
            : base(serviceProvider, damage,position,destinationCreep)
        {
            base.position = position;
            base.destinationCreep = destinationCreep;
            base.texture = content.Load<Texture2D>("Bullets/IceBullet");
            base.speed = 2;
